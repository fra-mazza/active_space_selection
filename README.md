...
- Overlaps with `|S| < 0.8` or `|S| > 1.2` are flagged as warnings in `ALTER.txt` and on standard output; when `|S| < 0.8`, the script also prints the second-best candidate orbital to aid manual checks.
